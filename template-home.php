...
<section class="section-me"> <!-- START SECTION ME -->
				<div class="grid-wrapper">
					<div class="grid one-fifth hide--palm hide--lap">
						<img src="img/icon_person.png" alt="Image Profile">
					</div>
					<div class="grid four-fifths palm-one-whole lap-one-whole">
						<div class="grid-wrapper">
							<div class="grid grid--me-hi one-seventh lap-two-eighths palm-one-whole">
								<img class="section-me__icon-hi" src="img/icon_hi.png" alt="Image saying Hi">
							</div>
				...
				<div class="separator seperator--me">
					<div class="separator__content">
						<img src="img/icon_heart_small.png" alt="Icon Of A Small Heart">
					</div>
				</div>
			...
			<section class="section-location"> <!-- START SECTION LOCATION -->
				<div class="grid-wrapper">
					...
					<div class="grid four-fifths palm-one-whole grid--location">
						...
						<div class="map">
							<img class="map__austria" src="img/icon_map.png" alt="">
							<img class="map__location" src="img/icon_map_location.png" alt="">
						</div>
					</div>
				</div>
			...
			<section class="section-love"> <!-- START SECTION LOVE -->
				<div class="grid-wrapper">
					<div class="grid one-fifth hide--palm">
						<img src="img/icon_heart.png" alt="Image of a heart">
					</div>
					<div class="grid four-fifths palm-one-whole">
						...
						<div class="awesome-sign">
							<img class="awesome-sign__shadow" src="img/icon_awesome_shadow.png" alt="Shadow Of Awesome Sign">
							<img class="awesome-sign__awesome"src="img/icon_awesome.png" alt="Icon Of Awesome Sign">
							<img class="awesome-sign__arrow hide--palm" src="img/icon_arrow.png" alt="Icon Of An Arrow">
							<div class="awesome-sign__devices">
								<img class="awesome-sign__device awesome-sign__devices-phone" src="img/icon_device_phone.png" alt="Image of A Phone">
								<img class="awesome-sign__device awesome-sign__devices-tablet" src="img/icon_device_tablet.png" alt="Image of A Phone">
								<img class="awesome-sign__device awesome-sign__devices-desktop" src="img/icon_device_desktop.png" alt="Image of A Phone">
							</div>
						</div>
					</div>
				</div>
